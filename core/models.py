...
class Item(models.Model):
    ...
    title = models.CharField(
        'Название', max_length=100, null=False, db_index=True
    )
    description = models.TextField('Описание')
    price = models.FloatField(
        'Цена', validators=[MinValueValidator(1, 'Минимальная цена - 1')],
        help_text='Цена в $', null=False
    )
    discount_price = models.FloatField(
        'Цена-Скидка', validators=[
            MinValueValidator(1, 'Минимальная цена - 1')],
        help_text='Цена в $', blank=True, null=True
    )
...
class Order(models.Model):
    ...
    ref_code = models.CharField(
        'Ссылочный код', max_length=25, blank=True, null=True
    )
    ...
    billing_address = models.ForeignKey(
        ...
        related_name='billing_address', verbose_name='Платежный адрес'
    )
    shipping_address = models.ForeignKey(
        'Address', on_delete=models.SET_NULL, blank=True, null=True,
        related_name='shipping_address', verbose_name='Адрес доставки'
    )
    ...
    def __str__(self):
        return (
            f'Корзина - {self.user.username} | ref_code - {self.ref_code}'
        )
...
class Address(models.Model):
    ...
    address_type = models.CharField(
        'Куда доставлять', max_length=1, choices=ADDRESS_CHOICES,
...
class Coupon(models.Model):
    ...
    amount = models.FloatField(
        'Скидка', validators=[MinValueValidator(1, 'Минимальная скидка - 1')],
        help_text='Скидка в $'
    )
...
class UserProfile(models.Model):
    ...
    one_click_purchasing = models.BooleanField('Покупка в один клик', default=False)
